...
/** **********************************************************************************************************
 * @brief Exemple d'appel d'une API. Cet exemple comporte trois différentes API.
 * Librairie construite à partir du tutorial Felgo suivant:
 * @see https://blog.felgo.com/cross-platform-app-development/access-rest-services-qt-felgo-weather-service-example-app-open-source#spoiler-basic-rest-example-with-v-play
 * ***********************************************************************************************************/
function requestAPI() {
...
/** **********************************************************************************************************
 * @brief Exemple 1: Envoi d'une requète GET au site Flikr.
 * @returns a JSON document with a list of photos.
 * ***********************************************************************************************************/
function sendtoFlicker(request) {
    request.open("GET",
                 "http://api.flickr.com/services/feeds/photos_public.gne?format=json&nojsoncallback=1&tags=Ibiza")
    request.send()
}


/** **********************************************************************************************************
 * @brief Exemple 2: Envoi d'une requète GET au site openWeatherMap avec API KEY.
 * @note Une API KEY est nécessaire. Il faut s'incrire sur le site.
...
/** **********************************************************************************************************
 * @brief Exemple 3: Envoi d'une requète POST au site deepAI avec body.
 * @note Une API KEY est nécessaire. Il faut s'incrire sur le site.
...
function sendtoDeepAI(request) {
    ...
    var keywords = "An old dual lens rolleiflex camera, with a neutral backgroud and black and withe colors." // "Panasonic camera, DMC-TZ10 model, with no background";
