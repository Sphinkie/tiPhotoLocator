...
\begin{DoxyCompactList}\small\item\em Ce slot ajoute ou modifie une propriété d\textquotesingle{}une \doxylink{struct_photo}{Photo}, par exemple si on clique sur une suggestion. \end{DoxyCompactList}\item 
...
Ce slot ajoute ou modifie une propriété d\textquotesingle{}une \doxylink{struct_photo}{Photo}, par exemple si on clique sur une suggestion. 
