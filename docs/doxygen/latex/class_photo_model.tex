...
\begin{DoxyCompactList}\small\item\em Adds a test item to the \doxylink{class_photo_model}{Photo\+Model}. (only if {\ttfamily Debug\+Mode} is enabled in the {\itshape settings}) \end{DoxyCompactList}\item 
...
Adds a test item to the \doxylink{class_photo_model}{Photo\+Model}. (only if {\ttfamily Debug\+Mode} is enabled in the {\itshape settings}) 
...
Met le flag {\bfseries{"{}is\+Selected"{}}} du précédent item à {\bfseries{False}} et le nouveau à {\bfseries{True}}. Met aussi le flag {\bfseries{"{}inside\+Circle"{}}} du précédent item à {\bfseries{False}} et le nouveau à {\bfseries{True}}. 
\begin{DoxyParams}{Parameters}
