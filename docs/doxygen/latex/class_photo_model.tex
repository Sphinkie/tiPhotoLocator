...
, {\bfseries Keywords\+Role}
 \}
\begin{DoxyCompactList}\small\item\em The Roles enum lists the roles associated to each attribute of a Photo. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Adds an item to the model, from a \textquotesingle{}key-\/value\textquotesingle{} dictionnary of metadata given in the. \end{DoxyCompactList}\item 
...
Adds an item to the model, from a \textquotesingle{}key-\/value\textquotesingle{} dictionnary of metadata given in the. 
...
Cette méthode permet de modifier plusieurs roles d\textquotesingle{}un item du modèle, avec comme clef le role \textquotesingle{}Filename\+Role\textquotesingle{}. Roles non modifiables (ignorés)\+: image\+Url, inside\+Circle. Roles non modifiables (recalculés)\+: has\+GPS, to\+Be\+Saved. Cette fonction positionne le flag "{}\+To\+Be\+Saved"{} à FALSE. Elle convient à la lecture (ou relecture) globale des tags Exif des photos originales. 
