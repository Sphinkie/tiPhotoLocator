...
\hline
\end{DoxyParams}
On utilise les conversions\+: {\bfseries{1°lat = 111km}} et {\bfseries{1°long = 111km x cos(lat)}}. \index{PhotoModel@{PhotoModel}!get@{get}}
...
L\textquotesingle{}item {\bfseries{Saved\+Position}}, de type {\bfseries{is\+Marker}} est supprimé du modèle. \index{PhotoModel@{PhotoModel}!roleNames@{roleNames}}
