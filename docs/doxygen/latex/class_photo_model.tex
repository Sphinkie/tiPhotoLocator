...
\begin{DoxyCompactList}\small\item\em Ce slot enregistre dans le fichier JPG les metadonnées IPTC qui ont été modifiées. \end{DoxyCompactList}\item 
...
void {\bfseries apply\+Creator\+To\+All} ()
\begin{DoxyCompactList}\small\item\em Applique le Settings "{}photographe"{} (le nom du photographe configuré) à toutes les photos du modèle. \end{DoxyCompactList}\item 
...
Ce slot enregistre dans le fichier JPG les metadonnées IPTC qui ont été modifiées. 

\begin{DoxyNote}{Note}
Tag obligatoire\+: image\+Url. 

Tags modifiés\+: GPS coords, Creator, City, Country, Date\+Time\+Original. 

Tags automatiques\+: GPS Ref, Metadata\+Editing\+Software. 
\end{DoxyNote}
...
Cette fonction met aussi à {\ttfamily TRUE} le flag {\ttfamily "{}\+To Be Saved"{}} car il s\textquotesingle{}agit d\textquotesingle{}une action opérateur. Cette fonction est appelée quand on clique sur un Chips, pour modifier une des propriétés de la \doxylink{struct_photo}{Photo}. Certains roles ne sont pas modifiables\+: image\+Url, is\+Selected, has\+GPS, filename, shutter\+Speed, F-\/number, etc. \begin{DoxySeeAlso}{See also}
