...
, {\bfseries Keywords\+Role}
 \}
\begin{DoxyCompactList}\small\item\em The \doxyref{Roles}{p.}{class_photo_model_afae44c634ae6bf2b6b6c2e2a19269159} enum lists the roles associated to each attribute of a \doxyref{Photo}{p.}{struct_photo}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em \doxyref{Photo\+Model\+::flags}{p.}{class_photo_model_a1304d28519eb274764ef65afffec6c96}. \end{DoxyCompactList}\item 
...
\index{PhotoModel@{PhotoModel}!Roles@{Roles}}
\index{Roles@{Roles}!PhotoModel@{PhotoModel}}
\doxysubsubsection{Roles}
{\footnotesize\ttfamily \label{class_photo_model_afae44c634ae6bf2b6b6c2e2a19269159} 
enum \textbf{ Photo\+Model\+::\+Roles}}



The \doxyref{Roles}{p.}{class_photo_model_afae44c634ae6bf2b6b6c2e2a19269159} enum lists the roles associated to each attribute of a \doxyref{Photo}{p.}{struct_photo}. 
...
{\footnotesize\ttfamily \label{class_photo_model_a244f996eed49122ebe11c5369d63a0e2} 
Photo\+Model\+::\+Photo\+Model (\begin{DoxyParamCaption}\item[{QObject $\ast$}]{parent}{ = {\ttfamily nullptr}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [explicit]}}
...
{\footnotesize\ttfamily \label{class_photo_model_af43bef19e91b11bf4e79c55fe458d0a1} 
void Photo\+Model\+::add\+Test\+Item (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a8a98d5f81789881189e179d6059c1586} 
void Photo\+Model\+::append (\begin{DoxyParamCaption}\item[{const QString}]{filename}{, }\item[{const QString}]{url}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a28933cf9451c4794c12325ac125f439f} 
void Photo\+Model\+::append (\begin{DoxyParamCaption}\item[{const QVariant\+Map}]{data}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{class_photo_model_a297fef9ba3dd5d7c1c00593cefaf144e} 
void Photo\+Model\+::append\+Saved\+Position (\begin{DoxyParamCaption}\item[{double}]{latitude}{, }\item[{double}]{longitude}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a536c2a2381b3ce827257068f5bf43933} 
void Photo\+Model\+::apply\+Creator\+To\+All (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
Le nom du photographe est configuré dans les Settings. \index{PhotoModel@{PhotoModel}!belong@{belong}}
\index{belong@{belong}!PhotoModel@{PhotoModel}}
\doxysubsubsection{belong()}
{\footnotesize\ttfamily \label{class_photo_model_aa63d16a07716d0ad5aff2ff1be183198} 
bool Photo\+Model\+::belong (\begin{DoxyParamCaption}\item[{double}]{p\+La}{, }\item[{double}]{p\+Lo}{, }\item[{double}]{o\+La}{, }\item[{double}]{o\+Lo}{, }\item[{float}]{r\+La}{, }\item[{float}]{r\+Lo}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a1ff9f0f539d9b65e0521ebbaa498b21b} 
void Photo\+Model\+::clear (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
On utilise cette fonction quand on scanne un nouveau répertoire de photos. \index{PhotoModel@{PhotoModel}!data@{data}}
\index{data@{data}!PhotoModel@{PhotoModel}}
\doxysubsubsection{data()}
{\footnotesize\ttfamily \label{class_photo_model_a3f09addf9a989e85b7ae5797156b270f} 
QVariant Photo\+Model\+::data (\begin{DoxyParamCaption}\item[{const QModel\+Index \&}]{index}{, }\item[{int}]{role}{ = {\ttfamily Qt\+:\+:DisplayRole}}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a822190ecc2081c7b49030c0f6a42317f} 
void Photo\+Model\+::dump\+Data (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{class_photo_model_aacde479b741e9f94c2077ad979e6b6a7} 
void Photo\+Model\+::duplicate\+Data (\begin{DoxyParamCaption}\item[{int}]{row}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a3cc8c0b5e6803970def517a8d57ae155} 
void Photo\+Model\+::fetch\+Exif\+Metadata (\begin{DoxyParamCaption}\item[{int}]{photo}{ = {\ttfamily -\/1}}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a8cd1ac5560f3897892474271c5206106} 
void Photo\+Model\+::find\+In\+Circle\+Photos (\begin{DoxyParamCaption}\item[{int}]{circle\+\_\+radius}{}\end{DoxyParamCaption})}
...
\hline
\end{DoxyParams}
On utilise les conversions\+: {\bfseries{1°lat = 111km}} et {\bfseries{1°long = 111km x cos(lat)}}. \index{PhotoModel@{PhotoModel}!flags@{flags}}
\index{flags@{flags}!PhotoModel@{PhotoModel}}
\doxysubsubsection{flags()}
{\footnotesize\ttfamily \label{class_photo_model_a1304d28519eb274764ef65afffec6c96} 
Qt\+::\+Item\+Flags Photo\+Model\+::flags (\begin{DoxyParamCaption}\item[{const QModel\+Index \&}]{index}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}}



\doxyref{Photo\+Model\+::flags}{p.}{class_photo_model_a1304d28519eb274764ef65afffec6c96}. 
...
{\footnotesize\ttfamily \label{class_photo_model_a18fb19d062f2f7d7d79585d2e62c9634} 
QVariant\+Map Photo\+Model\+::get (\begin{DoxyParamCaption}\item[{int}]{row}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{class_photo_model_a3c8036e57376630243dfa6841d7f2251} 
QString Photo\+Model\+::get\+Role\+Name (\begin{DoxyParamCaption}\item[{int}]{role}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\index{PhotoModel@{PhotoModel}!getSelectedRow@{getSelectedRow}}
\index{getSelectedRow@{getSelectedRow}!PhotoModel@{PhotoModel}}
\doxysubsubsection{getSelectedRow()}
{\footnotesize\ttfamily \label{class_photo_model_ae3dd8e3599f33e699cd474c5fca7d0b2} 
int Photo\+Model\+::get\+Selected\+Row (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a1d2159990dbea68afefa28bfdd6804fe} 
QVariant Photo\+Model\+::get\+Url (\begin{DoxyParamCaption}\item[{int}]{row}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{class_photo_model_a1e2f3f829e54ef445a5b1dea07ad2118} 
void Photo\+Model\+::remove\+Data (\begin{DoxyParamCaption}\item[{int}]{row}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a77dea7e487119a062064faa3c60ed2d6} 
void Photo\+Model\+::remove\+Photo\+Keyword (\begin{DoxyParamCaption}\item[{QString}]{keyword}{}\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \label{class_photo_model_a6c2e4a731969e952993dfe4d38e5788f} 
void Photo\+Model\+::remove\+Saved\+Position (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
L\textquotesingle{}item {\bfseries{Saved\+Position}}, de type {\bfseries{is\+Marker}} est supprimé du modèle. \index{PhotoModel@{PhotoModel}!resetCircle@{resetCircle}}
\index{resetCircle@{resetCircle}!PhotoModel@{PhotoModel}}
\doxysubsubsection{resetCircle()}
{\footnotesize\ttfamily \label{class_photo_model_a8b4c0daf563670d61c87102a19bead12} 
void Photo\+Model\+::reset\+Circle (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}



Enleve le flag "{}inside\+Circle"{} à toutes les photos. 
...
{\footnotesize\ttfamily \label{class_photo_model_aac3d5e1ae72e823b4e6091497c5cf27d} 
QHash$<$ int, QByte\+Array $>$ Photo\+Model\+::role\+Names (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a0fdbd69a007a6bda5623cce8d5f3cd57} 
int Photo\+Model\+::row\+Count (\begin{DoxyParamCaption}\item[{const QModel\+Index \&}]{parent}{}\end{DoxyParamCaption}) const\hspace{0.3cm}{\ttfamily [override]}}
...
{\footnotesize\ttfamily \label{class_photo_model_ac393e2839ea5993f199ec669973972ef} 
void Photo\+Model\+::save\+Metadata (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_aa9fed3a1b288e554337ded22bdb1cf35} 
void Photo\+Model\+::selected\+Row (\begin{DoxyParamCaption}\item[{const int}]{row}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [private]}}
...
{\footnotesize\ttfamily \label{class_photo_model_ad7a5d45624200d819ee0ab429387baa0} 
bool Photo\+Model\+::set\+Data (\begin{DoxyParamCaption}\item[{const QModel\+Index \&}]{index}{, }\item[{const QVariant \&}]{value}{, }\item[{int}]{role}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [override]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a606c1207c36cdf5e81f346ca82cec2d8} 
void Photo\+Model\+::set\+Data (\begin{DoxyParamCaption}\item[{const QVariant\+Map \&}]{value\+\_\+list}{}\end{DoxyParamCaption})}
...
\doxyref{Roles}{p.}{class_photo_model_afae44c634ae6bf2b6b6c2e2a19269159} non modifiables (ignorés)\+: {\ttfamily image\+Url, inside\+Circle}.~\newline
 \doxyref{Roles}{p.}{class_photo_model_afae44c634ae6bf2b6b6c2e2a19269159} non modifiables (recalculés)\+: {\ttfamily has\+GPS, to\+Be\+Saved}.~\newline
...
{\footnotesize\ttfamily \label{class_photo_model_a5aef53c6395a6ccd579a019c62e472e0} 
void Photo\+Model\+::set\+Data (\begin{DoxyParamCaption}\item[{int}]{row}{, }\item[{QString}]{value}{, }\item[{QString}]{property}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_aa35674fe9c8ec79d2993ce56614bb909} 
void Photo\+Model\+::set\+In\+Circle\+Item\+Coords (\begin{DoxyParamCaption}\item[{const double}]{latitude}{, }\item[{const double}]{longitude}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a50dc093e369a2741b62aa03556df061c} 
void Photo\+Model\+::set\+Photo\+Property (\begin{DoxyParamCaption}\item[{const int}]{photo}{, }\item[{const QString}]{value}{, }\item[{const QString}]{property}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a582509a3df1c2f9c0e6ae9f7c89e0294} 
void Photo\+Model\+::set\+Selected\+Item\+Coords (\begin{DoxyParamCaption}\item[{const double}]{latitude}{, }\item[{const double}]{longitude}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [slot]}}
...
{\footnotesize\ttfamily \label{class_photo_model_a3260014636b9e9ae523391a753be104c} 
void Photo\+Model\+::update\+Photo\+Keyword (\begin{DoxyParamCaption}\item[{QString}]{keyword}{, }\item[{int}]{index}{}\end{DoxyParamCaption})}
