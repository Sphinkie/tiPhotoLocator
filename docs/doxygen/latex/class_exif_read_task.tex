...
\begin{DoxyCompactList}\small\item\em \+: Lancement de la tache. On lance {\bfseries{exif\+Tool}} dans un process, et on analyse la réponse. \doxylink{class_cette}{Cette} tache est exécutée dans un thread QRunnable. A la fin de la tache, on écrit les résultat dans \doxylink{class_photo_model}{Photo\+Model}. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\begin{DoxyCompactList}\small\item\em Analyse une partie du flux texte reçu de exif\+Tool. \doxylink{class_cette}{Cette} méthode est appelée répétitivement. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
Analyse une partie du flux texte reçu de exif\+Tool. \doxylink{class_cette}{Cette} méthode est appelée répétitivement. 
