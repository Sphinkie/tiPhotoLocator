...
\begin{DoxyCompactList}\small\item\em \+: Lancement de la tache. On lance {\bfseries{exif\+Tool}} dans un process, et on analyse la réponse. Cette tache est exécutée dans un thread QRunnable. A la fin de la tache, on écrit les résultat dans \doxyref{Photo\+Model}{p.}{class_photo_model}. \end{DoxyCompactList}\end{DoxyCompactItemize}
