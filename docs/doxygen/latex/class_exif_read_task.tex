...
\hline
\end{DoxyParams}
\index{ExifReadTask@{ExifReadTask}!run@{run}}
\index{run@{run}!ExifReadTask@{ExifReadTask}}
\doxysubsubsection{run()}
{\footnotesize\ttfamily \label{class_exif_read_task_a1f0693a4aa7d57897f906d3db0fd77b8} 
void Exif\+Read\+Task\+::run (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [virtual]}}



Lancement de la tache. On lance {\bfseries{exif\+Tool}} dans un process, et on analyse la réponse. Cette tache est exécutée dans un thread QRunnable. A la fin de la tache, on écrit les résultats dans \doxyref{Photo\+Model}{p.}{class_photo_model}. 
