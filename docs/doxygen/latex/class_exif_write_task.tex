...
\begin{DoxyCompactList}\small\item\em Constructeur. On enregistre les paramètres. {\itshape exif\+Data\+:} la liste des metadata à écrire dans le fichier JPG. {\itshape generate\+Backup\+:} {\ttfamily true} si un backup de l\textquotesingle{}image doit être généré avant sa modification. \end{DoxyCompactList}\item 
...
Constructeur. On enregistre les paramètres. {\itshape exif\+Data\+:} la liste des metadata à écrire dans le fichier JPG. {\itshape generate\+Backup\+:} {\ttfamily true} si un backup de l\textquotesingle{}image doit être généré avant sa modification. 
